...
public class Player{
	...
	public CardBartok AddCard(CardBartok eCB)
	{
		...
		//sort cards in hand if the player is human
	...
	{
		Utils.tr (Utils.RoundToPlaces (Time.time), "Plater.CBCallback()", tCB.name,
		         "Player " + playerNum);
		Bartok.S.PassTurn ();
	}
}
